...
object tasklist extends Module {
  ...
  object backend extends AppScalaModule {
    ...
    def ivyDeps    = Agg(
      ivy"io.github.michalliss::foxxy-backend:0.0.10",
      ivy"io.github.michalliss::foxxy-repo:0.0.10",
      ivy"io.github.michalliss::foxxy-auth:0.0.10",
    ...
    object test extends ScalaTests with TestModule.ZioTest {
      def ivyDeps = Agg(
        ivy"io.github.michalliss::foxxy-testing:0.0.10",
  ...
  object shared extends Module {
    ...
    object jvm extends SharedModule {
      def ivyDeps = Agg(ivy"io.github.michalliss::foxxy-shared:0.0.10")
    }
