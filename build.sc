...
object tasklist extends Module {
  ...
  object backend extends AppScalaModule {
    ...
    def ivyDeps    = Agg(
      ivy"io.github.michalliss::foxxy-backend:0.0.8",
      ivy"io.github.michalliss::foxxy-repo:0.0.8",
      ivy"io.github.michalliss::foxxy-auth:0.0.8",
    ...
    object test extends ScalaTests with TestModule.ZioTest {
      def ivyDeps = Agg(
        ivy"io.github.michalliss::foxxy-testing:0.0.8",
  ...
  object frontend extends AppScalaJSModule {
    ...
    def ivyDeps    = Agg(
      ivy"io.github.michalliss::foxxy-frontend::0.0.8",
  ...
  object shared extends Module {
    ...
    object jvm extends SharedModule {
      def ivyDeps = Agg(ivy"io.github.michalliss::foxxy-shared:0.0.8")
    }
